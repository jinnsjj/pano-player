  ...
  <div id="options" role="group" aria-label="Media settings">
    ...
    <div id="overlay-options" class="settings-section" role="group" aria-labelledby="overlay-heading">
      ...
      <div class="overlay-control" role="group" aria-label="Grid overlay">
        ...
        <label class="overlay-opacity" title="Grid opacity"><input id="gridOpacity" type="range" min="0" max="1" step="0.01" value="1" aria-label="Grid opacity"><output id="gridOpacity-value" aria-hidden="true">100%</output></label>
      </div>
      <div class="overlay-control" role="group" aria-label="PowerMap overlay">
        ...
        <label class="overlay-opacity" title="PowerMap opacity"><input id="opacity" type="range" min="0" max="1" step="0.01" value="0.75" aria-label="PowerMap opacity"><output id="opacity-value" aria-hidden="true">75%</output></label>
      </div>
    </div></div>
